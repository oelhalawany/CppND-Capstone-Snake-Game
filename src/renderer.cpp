...
void Renderer::Render(Snake const snake, SDL_Point const &food, Obstacle const o) {
  SDL_Rect block;
  ...
  for (SDL_Point const &obstacle_obj : o.obstacle_objs) {
    block.x = obstacle_obj.x * block.w;
    block.y = obstacle_obj.y * block.h;
    SDL_RenderFillRect(sdl_renderer, &block);
  }
